...
public:
    ...
    {
        mat = matrix_float4x4{simd_float4{vs.get()[0] ,vs.get()[1] ,vs.get()[2], vs.get()[3] },
                              simd_float4{vs.get()[4] ,vs.get()[5] ,vs.get()[6], vs.get()[7] },
                              simd_float4{vs.get()[8] ,vs.get()[9] ,vs.get()[10],vs.get()[11]},
                              simd_float4{vs.get()[12],vs.get()[13],vs.get()[14],vs.get()[15]}};
    }
};
